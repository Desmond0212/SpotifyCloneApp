...
class LibraryAlbumsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // Listening Broadcast Notification Service.
    ...
    private func fetchData() {
        albums.removeAll()
        APICaller.shared.getCurrenctUserAlbums { [weak self] result in
            DispatchQueue.main.async {
                ...
                case .failure(let error):
                    print("LibraryAlbumsViewController getCurrenctUserPlaylists API onError - \(error.localizedDescription)")
                }
            }
        }
    }
