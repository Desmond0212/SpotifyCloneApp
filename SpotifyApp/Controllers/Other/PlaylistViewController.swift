...
class PlaylistViewController: UIViewController {
                    ...
                    APICaller.shared.removeTrackFromPlaylist(track: trackToDelete, playlist: strongSelf.playlist) { success in
                        DispatchQueue.main.async {
                            if success {
                                ...
                                print("PlaylistViewController: removeTrackFromPlaylist API Success")
                                print("PlaylistViewController: Track removed from Playlist")
                            }
                            else {
                                print("PlaylistViewController: removeTrackFromPlaylist API Failed")
                            }
                        }
                    }
                }
    ...
    // Sharing Spotify Play List with URL
...
extension PlaylistViewController: PlaylistHeaderCollectionReusableViewDelegate {
    func playlistHeaderCollectionReusableViewDidTapPlayAll(_ header: PlaylistHeaderCollectionReusableView) {
        // Start Playing Play List Item
        print("Spotify: Start Playing Play List Item...")
