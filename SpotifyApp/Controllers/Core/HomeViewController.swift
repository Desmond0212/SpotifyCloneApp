...
class HomeViewController: UIViewController {
            ...
            DispatchQueue.main.async {
                ...
                vc.selectionHandler = { playlist in
                    APICaller.shared.addTrackToPlaylist(
                        ...
                        print("Added to platlist success: \(success)")
                    }
                }
    ...
    private func fetchData() {
        /// API Services for Featured Play List, Recommended Tracks, New Releases Play List
    ...
    private func configureModels(
        ...
        print("New Album Count - \(newAlbums.count)")
...
extension HomeViewController: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        guard let header = collectionView.dequeueReusableSupplementaryView(ofKind: kind, withReuseIdentifier: TitleHeaderCollectionReusableView.identifier, for: indexPath
    ...
    static func createSectionLayout(section: Int) -> NSCollectionLayoutSection {
        ...
        case 0:
            ...
            // Collection Layout Group (Vertical Group in Horizontal Group)
